...
public class IncludeElementTest extends TestCase {
	...
	public void testIncludeFragment() throws IOException, HttpErrorPage {
		...
		provider.addResource("/testFragment",
				"before fragment <esi:fragment name=\"myFragment\">---fragment content---</esi:fragment> after fragment");
		StringWriter out = new StringWriter();
		tested.render(request, page, out);
	...
	public void testIncludeXpathSeveralMatchingNodes() throws IOException, HttpErrorPage {
		String page = "before "
				...
				+ " after";
		provider.addResource("/inline-xpath",
				"<html><title>The header</title><body>-the body-<br><ul><li>list item 1</li><li>list item 2</li></ul></body></html>");
		StringWriter out = new StringWriter();
		tested.render(request, page, out);
