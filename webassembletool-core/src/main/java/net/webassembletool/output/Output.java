...
public abstract class Output {
	...
	// This map has to be synchronized, because headers are updated by multiple
	// threads
	...
	public final void addHeader(String name, String value) {
		...
		if (values == null) {
			// This set has to be synchronized, because headers are updated by
			// multiple threads
			// see
			// https://sourceforge.net/apps/mantisbt/webassembletool/view.php?id=84
