...
public class PerformanceTestCase extends TestCase {
	...
	private final static String AGGREGATED1 = "http://localhost:8080/webassembletool-app-aggregated1/";
	private final static String AGGREGATED2 = "http://localhost:8080/webassembletool-app-aggregated2/";
	...
	public void testAggregator() throws Exception {
		...
		long execTimeAggregated1 = execute(runAggregated1, 500, 50);
		long execTimeAggregated2 = execute(runAggregated2, 500, 50);
		...
		long execTimeAggregator = execute(runAggregator, 500, 50);
		LOG.debug("Total execution time with aggregator (cache): "
				+ execTimeAggregator + "ms");

		long execTimeAggregatorNoCache = execute(runAggregatorNoCache, 500, 50);
	...
	public void testUrlWithCacheAndNumerousHeaders() throws Exception {
		HttpGetRequestRunnable runAggregated1 = new HttpGetRequestRunnable(
				AGGREGATOR + "small-cacheable-page.jsp");
		execute(runAggregated1, 1000, 200);
	}
